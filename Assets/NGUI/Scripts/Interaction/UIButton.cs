...
public class UIButton : UIButtonColor
{
	...
	{
#if UNITY_EDITOR
		// Added by Jeff, fixes problem when applying change to a prefab, "Normal" sprite will get revert back to old one.
		// http://www.tasharen.com/forum/index.php?topic=8885.0
		if (!Application.isPlaying)
		{
			mInitDone = false; // <-- this right here
			return;
		}
#endif
