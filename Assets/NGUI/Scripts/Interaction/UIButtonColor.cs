...
public class UIButtonColor : UIWidgetContainer
{
	...
	protected virtual void OnInit ()
	{
		...
		if (mWidget != null)
		{
            ...
            //20140827, Frank: if the mWidget color is (0,0,0,0) as initial, the default(normal) color will be set to invisible(Color(0,0,0,0))...
            if (mColor.a < 0.5f)
            {
                mColor = new Color(mColor.r, mColor.g, mColor.b, 1f);
            }
		}
		else
		{
