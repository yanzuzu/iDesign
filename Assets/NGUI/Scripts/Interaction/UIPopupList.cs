...
public class UIPopupList : UIWidgetContainer
{
	...
	// add On Press Event by pig 2014/7/16
	public delegate void OnItemPressCb();
	public OnItemPressCb m_ItemPressCb;
