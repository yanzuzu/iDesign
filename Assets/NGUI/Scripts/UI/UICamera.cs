...
public class UICamera : MonoBehaviour
{
	...
	public void ProcessMouse ()
	{
		...
		// Ville Project Spec. Only Use Mouse Left Button
		int mouseBtns = 3;	// Default
#if UNITY_WEBPLAYER
		mouseBtns = 1;
#endif
	...
	public void ProcessTouch (bool pressed, bool unpressed)
	{
		...
		if (unpressed)
		{
			...
			if (currentTouch.pressed != null)
			{
				...
				// in order to avoid hover sound playing , setting false by sam 2014/10/21 
				if (isMouse) Notify(currentTouch.current, "OnHover", false);
